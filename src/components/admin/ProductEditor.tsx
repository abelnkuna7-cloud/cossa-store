 ...
 *
 * IMPORTANT:
 * This must remain a named export because ProductCarousel and ProductGrid
 * both consume ProductCard.
 */
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-3 sm:p-4">
        ...
        product.affiliate ? (
          <div className="mt-2 rounded-md border border-border bg-secondary/30 p-2">
            <p className="text-[11px] leading-relaxed text-muted-foreground">
              {product.affiliate
                .disclosure_text ??
                `Sold and fulfilled by ${product.affiliate.partner_name}. Purchase takes place on the partner's website. Cossa Store may earn a commission.`}
            </p>
          </div>
        ) : null}
        ...
        <div className="mt-auto flex items-center gap-2 pt-3">
          ...
          {/* WISHLIST
              Affiliate offers are intentionally excluded because the
              transaction takes place on a third-party merchant website.
          */}
          {affiliate ? null : (
            <Button
              type="button"
 ...
 *
 * Product visibility/publication filtering should happen in the catalogue
 * query/service layer rather than here so ProductGrid, ProductCarousel,
 * search and recommendations all receive the same catalogue truth.
 */
